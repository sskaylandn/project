    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="table-responsive text-nowrap">
            ...
            <tbody class="table-border-bottom-0">
                <?php $__empty_1 = true; $__currentLoopData = $data_pengajuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                ...
                <td>
                    <a href="<?php echo e(url('user/edit-rfc', $item->id_rfc)); ?>"><span class="btn btn-primary rounded-2 fw-semibold">Edit</span></a>
                    <form action="<?php echo e(url('user/delete-rfc', $item->id_rfc)); ?>" class="mt-3" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('user.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\magang\project\resources\views/user/rfc/index.blade.php ENDPATH**/ ?>