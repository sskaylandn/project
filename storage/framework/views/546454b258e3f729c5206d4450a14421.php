    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="table-responsive text-nowrap">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <td><a href="<?php echo e(url('admin/edit-rfc', $item->id_rfc)); ?>"><span class="badge bg-label-primary me-1">Tindak Lanjut</span></a></td>
                </tr>    
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\magang\project\resources\views/admin/rfc/index.blade.php ENDPATH**/ ?>