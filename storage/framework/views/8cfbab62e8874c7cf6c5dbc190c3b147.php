    ...
    <div class="row">
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="<?php echo e(url('user/update-backup', $backup->id_backup)); ?>" method="post">
              <?php echo csrf_field(); ?>
              <div class="row mb-3">
                ...
                <div class="col-sm-10  mb-3">
                    <select class="form-select" name="periode" id="inputGroupSelect01">
                      <option selected><?php echo e($backup->periode); ?></option>
              ...
              <div class="row mb-4">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" name="tanggal" id="basic-default-name" value="<?php echo e($backup->tanggal); ?>" />
                </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-sm-10  mb-3">
                    <select class="form-select" name="objek" id="inputGroupSelect01">
                      <option selected><?php echo e($backup->objek); ?></option>
              ...
              <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="pj" id="basic-default-name" value="<?php echo e($backup->pj); ?>" />
                  </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea
                    ...
                    aria-describedby="basic-icon-default-message2"><?php echo e($backup->keterangan); ?></textarea>
                </div>
              </div>
              <div class="row mt-3">
                <div class="">
...
<?php echo $__env->make('user.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\magang\project\resources\views/user/backup/edit.blade.php ENDPATH**/ ?>