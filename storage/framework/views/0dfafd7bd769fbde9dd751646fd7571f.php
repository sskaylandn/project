<?php $__env->startSection('main_content'); ?>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-xxl">
            ...
            <div class="card-body">
                <form action="<?php echo e(url('user/submit-rfc')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="pengaju" id="basic-default-name" value="<?php echo e(auth()->user()->username); ?>" />
                    </div>
                </div>
                <div class="row mb-3">
...
<?php echo $__env->make('user.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\magang\project\resources\views/user/rfc/create.blade.php ENDPATH**/ ?>