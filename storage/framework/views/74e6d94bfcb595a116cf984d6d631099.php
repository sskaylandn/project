    ...
    <div class="row">
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="<?php echo e(url('user/submit-backup')); ?>" method="post">
              <?php echo csrf_field(); ?>
              <div class="row mb-3">
...
<?php echo $__env->make('user.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\magang\project\resources\views/user/backup/create.blade.php ENDPATH**/ ?>